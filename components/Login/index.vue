    ...
    <transition name="login" mode="out-in">
      ...
      <div class="login" :key="'password'" v-if="passwordMode">
        ...
        <div>
          ...
          <el-input @keyup.enter.native="submitPassword" type="email" :placeholder="$t('SW_YOUR_EMAIL_SHORT')" name="email" id="email" prefix-icon="icon-email" class="mb-5" v-model="form.email"></el-input>
