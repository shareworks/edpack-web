    ...
    <affix class="sticky-bar" relative-element-selector="#sticky-content" :offset="{ top: 148, bottom: -1000 }">
      <el-row type="flex" justify="center" align="middle">
        ...
        <el-col :xs="16" :sm="12" class="course-header-filter">
          <!-- Select a faculty -->
          <el-select v-model="facultyFilter" clearable class="mr-10" :placeholder="$t('SW_FACULTY', [school.terminology.faculty[lang].toLowerCase()])" size="medium" @change="changeFilter" v-if="school.faculties.length > 1 && !cards">
