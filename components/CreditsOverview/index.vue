<template>
  <div>
    <page-cover v-if="inDialog" class="mb-30">
      ...
      {{ $t('SW_CREDITS_REMAINING_INFO', [school.name[lang], appName, school.terminology.instructor[lang].toLowerCase()])}} <a href="#" @click.prevent="contactUs">{{ $t('SW_CONTACT_SUPPORT') }}</a>.
    </page-cover>
